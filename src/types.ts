...
export const DEFAULT_CATEGORIES: CategoryDef[] = [
  { id: 'study-test', label: 'Studying — Test', color: '#e5484d', weight: 10, builtin: true },
  { id: 'study-quiz', label: 'Studying — Quiz', color: '#f76808', weight: 8, builtin: true },
  { id: 'homework', label: 'Homework', color: '#3e63dd', weight: 6, builtin: true },
  { id: 'classes', label: 'Classes', color: '#8e4ec6', weight: 5, builtin: true },
  { id: 'work', label: 'Work', color: '#30a46c', weight: 4, builtin: true },
  { id: 'chores', label: 'Chores', color: '#80838d', weight: 3, builtin: true },
];
